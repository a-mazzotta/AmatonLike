...
\vspace*{7cm}
\begin{center}%
{\Large Ama\+Ton\+Like \\[1ex]\large 1.\+0 }\\
\vspace*{1cm}
{\large Generato da Doxygen 1.8.16}\\
\end{center}
\end{titlepage}
...
\input{structacquirente__t}
\input{structcorriere__t}
\input{structesercente__t}
\input{structprodotto__t}
\chapter{Documentazione dei file}
\input{constants_8h}
\input{home__account_8h}
\input{input_8h}
\input{librerie_8h}
\input{login_8h}
\input{menu__design_8h}
\input{specifiche_8h}
\input{struct_8h}
